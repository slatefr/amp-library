...
class ValidationRulesFactory {
  ...
  $o_0->tags[] = $o_994;
  $o_amp_consent_head = new TagSpec();
  $o_amp_consent_head->tag_name = 'script';
  $o_amp_consent_head->spec_name = 'amp-consent extension .js script';
  $o_amp_consent_head->mandatory_parent = 'head';
  $o_amp_consent_head_async = new AttrSpec();
  $o_amp_consent_head_async->name = 'async';
  $o_amp_consent_head_async->mandatory = true;
  $o_amp_consent_head_async->value = '';
  $o_amp_consent_head->attrs[] = $o_amp_consent_head_async;
  $o_amp_consent_head_custom = new AttrSpec();
  $o_amp_consent_head_custom->name = 'custom-element';
  $o_amp_consent_head_custom->mandatory = true;
  $o_amp_consent_head_custom->value = 'amp-consent';
  $o_amp_consent_head_custom->dispatch_key = true;
  $o_amp_consent_head->attrs[] = $o_amp_consent_head_custom;
  $o_amp_consent_head_src = new AttrSpec();
  $o_amp_consent_head_src->name = 'src';
  $o_amp_consent_head_src->mandatory = true;
  $o_amp_consent_head_src->value_regex = 'https://cdn\\.ampproject\\.org/v0/amp-consent-(latest|0\\.1).js';
  $o_amp_consent_head->attrs[] = $o_amp_consent_head_src;
  $o_amp_consent_head_type = new AttrSpec();
  $o_amp_consent_head_type->name = 'type';
  $o_amp_consent_head_type->value = 'text/javascript';
  $o_amp_consent_head->attrs[] = $o_amp_consent_head_type;
  $o_amp_consent_head->spec_url = 'https://www.ampproject.org/docs/reference/extended/amp-consent.html';
  $o_amp_consent_head_spec = new CdataSpec();
  $o_amp_consent_head_regex = new BlackListedCDataRegex();
  $o_amp_consent_head_regex->regex = '.';
  $o_amp_consent_head_regex->error_message = 'contents';
  $o_amp_consent_head_spec->blacklisted_cdata_regex[] = $o_amp_consent_head_regex;
  $o_amp_consent_head->cdata = $o_amp_consent_head_spec;
  $o_0->tags[] = $o_amp_consent_head;
  $o_amp_consent_body = new TagSpec();
  $o_amp_consent_body->tag_name = 'amp-consent';
  $o_amp_consent_body->attr_lists = ['extended-amp-global'];
  $o_amp_consent_body->spec_url = 'https://www.ampproject.org/docs/reference/extended/amp-consent.html';
  $o_amp_consent_body_type = new AttrSpec();
  $o_amp_consent_body_type->name = 'type';
  $o_amp_consent_body->attrs[] = $o_amp_consent_body_type;
  $o_amp_consent_body_id = new AttrSpec();
  $o_amp_consent_body_id->name = 'id';
  $o_amp_consent_body_id->mandatory = true;
  $o_amp_consent_body->attrs[] = $o_amp_consent_body_id;
  $o_amp_consent_body_layout = new AmpLayout();
  $o_amp_consent_body_layout->supported_layouts = [AmpLayoutLayout::NODISPLAY];
  $o_amp_consent_body->amp_layout = $o_amp_consent_body_layout;
  $o_amp_consent_body->disallowed_ancestor = ['head', 'amp-sidebar'];
  $o_amp_consent_body->also_requires_tag = ['amp-analytics extension .js script', 'amp-consent extension .js script'];
  $o_0->tags[] = $o_amp_consent_body;
  $o_amp_consent_body_script = new TagSpec();
  $o_amp_consent_body_script->tag_name = 'script';
  $o_amp_consent_body_script->spec_name = 'amp-consent extension .json script';
  $o_amp_consent_body_script->mandatory_parent = 'amp-consent';
  $o_amp_consent_body_script_type = new AttrSpec();
  $o_amp_consent_body_script_type->name = 'type';
  $o_amp_consent_body_script_type->mandatory = true;
  $o_amp_consent_body_script_type->value = 'application/json';
  $o_amp_consent_body_script_type->dispatch_key = true;
  $o_amp_consent_body_script->attrs[] = $o_amp_consent_body_script_type;
  $o_amp_consent_body_script->spec_url = 'https://www.ampproject.org/docs/reference/extended/amp-consent.html';
  $o_amp_consent_body_script_spec = new CdataSpec();
  $o_amp_consent_body_script_regex = new BlackListedCDataRegex();
  $o_amp_consent_body_script_regex->regex = '<!--';
  $o_amp_consent_body_script_regex->error_message = 'html comments';
  $o_amp_consent_body_script_spec->blacklisted_cdata_regex[] = $o_amp_consent_body_script_regex;
  $o_amp_consent_body_script->cdata = $o_amp_consent_body_script_spec;
  $o_0->tags[] = $o_amp_consent_body_script;
  $o_amp_sticky_ad = new TagSpec();
  $o_amp_sticky_ad->tag_name = 'amp-sticky-ad';
  $o_amp_sticky_ad_alt = new AttrSpec();
  $o_amp_sticky_ad_alt->name = 'alt';
  $o_amp_sticky_ad->attrs[] = $o_amp_sticky_ad_alt;
  $o_amp_sticky_ad_json = new AttrSpec();
  $o_amp_sticky_ad_json->name = 'json';
  $o_amp_sticky_ad->attrs[] = $o_amp_sticky_ad_json;
  $o_amp_sticky_ad_rtc = new AttrSpec();
  $o_amp_sticky_ad_rtc->name = 'rtc-config';
  $o_amp_sticky_ad->attrs[] = $o_amp_sticky_ad_rtc;
  $o_amp_sticky_ad_src = new AttrSpec();
  $o_amp_sticky_ad_src->name = 'src';
  $o_amp_sticky_ad_src_url = new UrlSpec();
  $o_amp_sticky_ad_src_url->allowed_protocol = ['https'];
  $o_amp_sticky_ad_src_url->allow_relative = true;
  $o_amp_sticky_ad_src->value_url = $o_amp_sticky_ad_src_url;
  $o_amp_sticky_ad->attrs[] = $o_amp_sticky_ad_src;
  $o_amp_sticky_ad_type = new AttrSpec();
  $o_amp_sticky_ad_type->name = 'type';
  $o_amp_sticky_ad_type->mandatory = true;
  $o_amp_sticky_ad->attrs[] = $o_amp_sticky_ad_type;
  $o_amp_sticky_ad->attr_lists = ['extended-amp-global'];
  $o_amp_sticky_ad->spec_url = 'https://www.ampproject.org/docs/reference/amp-ad.html';
  $o_amp_sticky_ad_layout = new AmpLayout();
  $o_amp_sticky_ad_layout->supported_layouts = [AmpLayoutLayout::FILL, AmpLayoutLayout::FIXED, AmpLayoutLayout::FIXED_HEIGHT, AmpLayoutLayout::FLEX_ITEM, AmpLayoutLayout::NODISPLAY, AmpLayoutLayout::RESPONSIVE];
  $o_amp_sticky_ad->amp_layout = $o_amp_sticky_ad_layout;
  $o_amp_sticky_ad->disallowed_ancestor = ['amp-sidebar'];
  $o_0->tags[] = $o_amp_sticky_ad;
  $o_amp_position_observer_head = new TagSpec();
  $o_amp_position_observer_head->tag_name = 'script';
  $o_amp_position_observer_head->spec_name = 'amp-position-observer extension .js script';
  $o_amp_position_observer_head->mandatory_parent = 'head';
  $o_amp_position_observer_head_async = new AttrSpec();
  $o_amp_position_observer_head_async->name = 'async';
  $o_amp_position_observer_head_async->mandatory = true;
  $o_amp_position_observer_head_async->value = '';
  $o_amp_position_observer_head->attrs[] = $o_amp_position_observer_head_async;
  $o_amp_position_observer_head_custom = new AttrSpec();
  $o_amp_position_observer_head_custom->name = 'custom-element';
  $o_amp_position_observer_head_custom->mandatory = true;
  $o_amp_position_observer_head_custom->value = 'amp-position-observer';
  $o_amp_position_observer_head_custom->dispatch_key = true;
  $o_amp_position_observer_head->attrs[] = $o_amp_position_observer_head_custom;
  $o_amp_position_observer_head_src = new AttrSpec();
  $o_amp_position_observer_head_src->name = 'src';
  $o_amp_position_observer_head_src->mandatory = true;
  $o_amp_position_observer_head_src->value_regex = 'https://cdn\\.ampproject\\.org/v0/amp-position-observer-(latest|0\\.1).js';
  $o_amp_position_observer_head->attrs[] = $o_amp_position_observer_head_src;
  $o_amp_position_observer_head_type = new AttrSpec();
  $o_amp_position_observer_head_type->name = 'type';
  $o_amp_position_observer_head_type->value = 'text/javascript';
  $o_amp_position_observer_head->attrs[] = $o_amp_position_observer_head_type;
  $o_amp_position_observer_head->spec_url = 'https://amp.dev/documentation/components/amp-position-observer/';
  $o_amp_position_observer_head_spec = new CdataSpec();
  $o_amp_position_observer_head_regex = new BlackListedCDataRegex();
  $o_amp_position_observer_head_regex->regex = '.';
  $o_amp_position_observer_head_regex->error_message = 'contents';
  $o_amp_position_observer_head_spec->blacklisted_cdata_regex[] = $o_amp_position_observer_head_regex;
  $o_amp_position_observer_head->cdata = $o_amp_position_observer_head_spec;
  $o_0->tags[] = $o_amp_position_observer_head;
  $o_amp_position_observer_body = new TagSpec();
  $o_amp_position_observer_body->tag_name = 'amp-position-observer';
  $o_amp_position_observer_body_ratio = new AttrSpec();
  $o_amp_position_observer_body_ratio->name = 'intersection-ratios';
  $o_amp_position_observer_body->attrs[] = $o_amp_position_observer_body_ratio;
  $o_amp_position_observer_body_on = new AttrSpec();
  $o_amp_position_observer_body_on->name = 'on';
  $o_amp_position_observer_body->attrs[] = $o_amp_position_observer_body_on;
  $o_amp_position_observer_body->attr_lists = ['extended-amp-global'];
  $o_amp_position_observer_body->spec_url = 'https://amp.dev/documentation/components/amp-position-observer/';
  $o_amp_position_observer_body_layout = new AmpLayout();
  $o_amp_position_observer_body_layout->supported_layouts = [AmpLayoutLayout::FILL, AmpLayoutLayout::FIXED, AmpLayoutLayout::FIXED_HEIGHT, AmpLayoutLayout::FLEX_ITEM, AmpLayoutLayout::NODISPLAY, AmpLayoutLayout::RESPONSIVE];
  $o_amp_position_observer_body->amp_layout = $o_amp_position_observer_body_layout;
  $o_0->tags[] = $o_amp_position_observer_body;
  $o_amp_animation_head = new TagSpec();
  $o_amp_animation_head->tag_name = 'script';
  $o_amp_animation_head->spec_name = 'amp-animation extension .js script';
  $o_amp_animation_head->mandatory_parent = 'head';
  $o_amp_animation_head_async = new AttrSpec();
  $o_amp_animation_head_async->name = 'async';
  $o_amp_animation_head_async->mandatory = true;
  $o_amp_animation_head_async->value = '';
  $o_amp_animation_head->attrs[] = $o_amp_animation_head_async;
  $o_amp_animation_head_custom = new AttrSpec();
  $o_amp_animation_head_custom->name = 'custom-element';
  $o_amp_animation_head_custom->mandatory = true;
  $o_amp_animation_head_custom->value = 'amp-animation';
  $o_amp_animation_head_custom->dispatch_key = true;
  $o_amp_animation_head->attrs[] = $o_amp_animation_head_custom;
  $o_amp_animation_head_src = new AttrSpec();
  $o_amp_animation_head_src->name = 'src';
  $o_amp_animation_head_src->mandatory = true;
  $o_amp_animation_head_src->value_regex = 'https://cdn\\.ampproject\\.org/v0/amp-animation-(latest|0\\.1).js';
  $o_amp_animation_head->attrs[] = $o_amp_animation_head_src;
  $o_amp_animation_head_type = new AttrSpec();
  $o_amp_animation_head_type->name = 'type';
  $o_amp_animation_head_type->value = 'text/javascript';
  $o_amp_animation_head->attrs[] = $o_amp_animation_head_type;
  $o_amp_animation_head->spec_url = 'https://amp.dev/documentation/components/amp-animation/';
  $o_amp_animation_head_spec = new CdataSpec();
  $o_amp_animation_head_regex = new BlackListedCDataRegex();
  $o_amp_animation_head_regex->regex = '.';
  $o_amp_animation_head_regex->error_message = 'contents';
  $o_amp_animation_head_spec->blacklisted_cdata_regex[] = $o_amp_animation_head_regex;
  $o_amp_animation_head->cdata = $o_amp_animation_head_spec;
  $o_0->tags[] = $o_amp_animation_head;
  $o_amp_animation_body = new TagSpec();
  $o_amp_animation_body->tag_name = 'amp-animation';
  $o_amp_animation_body_id = new AttrSpec();
  $o_amp_animation_body_id->name = 'id';
  $o_amp_animation_body->attrs[] = $o_amp_animation_body_id;
  $o_amp_animation_body_layout = new AmpLayout();
  $o_amp_animation_body_layout->supported_layouts = [AmpLayoutLayout::FILL, AmpLayoutLayout::FIXED, AmpLayoutLayout::FIXED_HEIGHT, AmpLayoutLayout::FLEX_ITEM, AmpLayoutLayout::NODISPLAY, AmpLayoutLayout::RESPONSIVE];
  $o_amp_animation_body->amp_layout = $o_amp_animation_body_layout;
  $o_0->tags[] = $o_amp_animation_body;
  $o_amp_animation_body_script = new TagSpec();
  $o_amp_animation_body_script->tag_name = 'script';
  $o_amp_animation_body_script->spec_name = 'amp-animation extension .json script';
  $o_amp_animation_body_script->mandatory_parent = 'amp-animation';
  $o_amp_animation_body_script_type = new AttrSpec();
  $o_amp_animation_body_script_type->name = 'type';
  $o_amp_animation_body_script_type->mandatory = true;
  $o_amp_animation_body_script_type->value = 'application/json';
  $o_amp_animation_body_script_type->dispatch_key = true;
  $o_amp_animation_body_script->attrs[] = $o_amp_animation_body_script_type;
  $o_amp_animation_body_script->spec_url = 'https://www.ampproject.org/docs/reference/extended/amp-animation.html';
  $o_amp_animation_body_script_spec = new CdataSpec();
  $o_amp_animation_body_script_regex = new BlackListedCDataRegex();
  $o_amp_animation_body_script_regex->regex = '<!--';
  $o_amp_animation_body_script_regex->error_message = 'html comments';
  $o_amp_animation_body_script_spec->blacklisted_cdata_regex[] = $o_amp_animation_body_script_regex;
  $o_amp_animation_body_script->cdata = $o_amp_animation_body_script_spec;
  $o_0->tags[] = $o_amp_animation_body_script;
  $o_996 = new TagSpec();
