...
class ValidationRulesFactory {
  ...
  $o_amp_position_observer = new TagSpec();
  $o_amp_position_observer->tag_name = 'amp-position-observer';
  $o_amp_position_observer_ratio = new AttrSpec();
  $o_amp_position_observer_ratio->name = 'intersection-ratios';
  $o_amp_position_observer->attrs[] = $o_amp_position_observer_ratio;
  $o_amp_position_observer_on = new AttrSpec();
  $o_amp_position_observer_on->name = 'on';
  $o_amp_position_observer->attrs[] = $o_amp_position_observer_on;
  $o_amp_position_observer->attr_lists = ['extended-amp-global'];
  $o_amp_position_observer->spec_url = 'https://amp.dev/documentation/components/amp-position-observer/';
  $o_amp_position_observer_layout = new AmpLayout();
  $o_amp_position_observer_layout->supported_layouts = [AmpLayoutLayout::FILL, AmpLayoutLayout::FIXED, AmpLayoutLayout::FIXED_HEIGHT, AmpLayoutLayout::FLEX_ITEM, AmpLayoutLayout::NODISPLAY, AmpLayoutLayout::RESPONSIVE];
  $o_amp_position_observer->amp_layout = $o_amp_position_observer_layout;
  $o_0->tags[] = $o_amp_position_observer;$o_amp_animation = new TagSpec();
  $o_amp_animation->tag_name = 'amp-animation';
  $o_amp_animation_id = new AttrSpec();
  $o_amp_animation_id->name = 'id';
  $o_amp_animation->attrs[] = $o_amp_animation_id;
  $o_amp_animation_layout = new AmpLayout();
  $o_amp_animation_layout->supported_layouts = [AmpLayoutLayout::FILL, AmpLayoutLayout::FIXED, AmpLayoutLayout::FIXED_HEIGHT, AmpLayoutLayout::FLEX_ITEM, AmpLayoutLayout::NODISPLAY, AmpLayoutLayout::RESPONSIVE];
  $o_amp_animation->amp_layout = $o_amp_animation_layout;
  $o_0->tags[] = $o_amp_animation;
  $o_996 = new TagSpec();
