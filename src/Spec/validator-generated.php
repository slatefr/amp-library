...
class ValidationRulesFactory {
  ...
  $o_amp_position_observer = new AmpLayout();
  $o_amp_position_observer->supported_layouts = [AmpLayoutLayout::FILL, AmpLayoutLayout::FIXED, AmpLayoutLayout::FIXED_HEIGHT, AmpLayoutLayout::FLEX_ITEM, AmpLayoutLayout::NODISPLAY, AmpLayoutLayout::RESPONSIVE];
  $o_amp_position_observer->amp_layout = $o_amp_sticky_ad_layout;
  $o_0->tags[] = $o_amp_position_observer;
  $o_996 = new TagSpec();
